...
function onKeyDown(e) {
  if (e.keyCode === KEY_CODE_LEFT || e.keyCode === KEY_CODE_ARROW_LEFT) {
    GAME_STATE.leftPressed = true;
  } else if (e.keyCode === KEY_CODE_RIGHT || e.keyCode === KEY_CODE_ARROW_RIGHT) {
    GAME_STATE.rightPressed = true;
  } else if (e.keyCode === KEY_CODE_PRESS) {
